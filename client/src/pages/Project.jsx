...
if(error) return <p>Something went wrong</p>
 ...
 return<div className="flex justify-center items-center flex-col">
 {
    !loading && !error && (
        ...
        <div className=" w-96 border-2 border-gray-200 px-8 py-4 my-6 rounded-lg lg:max-w-6xl lg:w-screen lg:py-20" >
            <div className="flex justify-between">
            <div>
            <h1 className="text-3xl font-semibold pt-3">{data.project.name}</h1>
